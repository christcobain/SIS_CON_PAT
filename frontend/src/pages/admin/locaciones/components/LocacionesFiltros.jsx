    ...
    <div className="card shadow-sm border border-border bg-surface overflow-hidden transition-all duration-300">
      <div className="p-5">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
          ...
          {/* Búsqueda Principal — Colspan variable según el contexto */}
          ...
          {/* Filtro Empresa — Dinámico para Sedes */}
          {activeTab === 'sedes' && (
            <div className="md:col-span-4 lg:col-span-3">
              <label className="text-[10px] font-black uppercase tracking-[0.15em] text-muted mb-2 block ml-1">Entidad / Empresa</label>
              <select
          ...
          <div className="md:col-span-2 lg:col-span-2">
            <label className="text-[10px] font-black uppercase tracking-[0.15em] text-muted mb-2 block ml-1">Disponibilidad</label>
            <select
