...
class Bien(models.Model):
    ...
    numero_serie          = models.CharField(max_length=100, unique=True, null=False, blank=True)
    codigo_patrimonial    = models.CharField(max_length=50, unique=True, null=False, blank=True)
