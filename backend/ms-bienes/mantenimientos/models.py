...
class Mantenimiento(models.Model):
    ...
    fecha_confirmacion_propietario    = models.DateTimeField(null=True, blank=True)
...
class MantenimientoDetalle(models.Model):
    ...
    estado_funcionamiento_inicial= models.ForeignKey(CatEstadoFuncionamiento, on_delete=models.SET_NULL,null=True, blank=True, related_name='detalles_antes',)
    ...
    estado_funcionamiento_final = models.ForeignKey(CatEstadoFuncionamiento, on_delete=models.SET_NULL,null=True, blank=True, related_name='detalles_despues',)
    ...
    def __str__(self):
        return f'{self.mantenimiento.numero_orden}| {self.bien.tipo_bien} | {self.bien.marca} |{self.bien.modelo} |{self.bien.numero_serie} | {self.bien.codigo_patrimonial}'
...
class MantenimientoAprobacion(models.Model):
    ...
    ROL_CHOICES = [
        ...
        ('userCorte',  'Usuario Propietario del Bien'),
    ]
