...
from .views import (
    LoginViewSet, LoginSessionViewSet, LoginSessionHistorialViewSet,
    LoginAttemptViewSet, CredentialViewSet,
    LogoutViewSet, RefreshTokenViewSet,
...
router.register(r'login/sessions/historial', LoginSessionHistorialViewSet, basename='sessions-historial')
