...
MS_SERVICE_NAME  = os.getenv('MS_SERVICE_NAME', 'ms-reportes')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'API Reportes — Sistema de Control Patrimonial CSJLN',
    'DESCRIPTION': 'ms-reportes: reportes, dashboard y auditoría',
    'VERSION': '1.0.0',
